...
from splitter.api import User_Resource, Profile_Resource, Profile_Friend_Resource, Group_Resource, Group_Friend_Resource, Expense_Resource, Splitter_Resource, Expense_Total_Resource, Settle_Resource
...
splitter_resource = Splitter_Resource()
...
urlpatterns = [
    ...
    url(r'', include(splitter_resource.urls)),
