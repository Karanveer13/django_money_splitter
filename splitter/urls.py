...
from splitter.api import User_Resource, Profile_Resource, Profile_Friend_Resource, Group_Resource, Group_Friend_Resource, Expense_Resource, Expense_Member_Resource, Expense_Total_Resource, Settle_Resource
...
expense_member_resource = Expense_Member_Resource()
...
urlpatterns = [
    ...
    url(r'', include(expense_member_resource.urls)),
